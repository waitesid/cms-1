      ...
      * @license https://github.com/openemr/openemr/blob/master/LICENSE GNU General Public License 3
       ...
       01  CAR-REDUCE01.
           02 CAR-REDUCE PIC S9(4)V99 OCCURS 50 TIMES.    
       ...
       01  CAR-ALLOWED01.
           02 CAR-ALLOWED PIC S9(4)V99 OCCURS 50 TIMES.   

       01  CAS-PAID01.
           02 CAS-PAID PIC S9(4)V99 OCCURS 50 TIMES.
       01  CAR-PAID01.
           02 CAR-PAID PIC S9(4)V99 OCCURS 50 TIMES.
       ...
       01  CAR-PAYDATE01.
           02 CAR-PAYDATE PIC X(8) OCCURS 50 TIMES.    

       01  TOT-BAL PIC S9(4)V99.

       01  CAS-TOT-REDUCE PIC 9(4)V99.
       01  CAR-TOT-REDUCE PIC 9(4)V99.

       01  CAS-TOT-CHARGE PIC 9(4)V99.
       01  CAR-TOT-CHARGE PIC 9(4)V99.

       01  CAS-TOT-ALLOWED PIC 9(4)V99.
       01  CAR-TOT-ALLOWED PIC 9(4)V99.

       01  CAS-TOT-PAID PIC 9(4)V99.
       01  CAR-TOT-PAID PIC 9(4)V99.
      ...
      *     WRITE SEGFILE01 FROM REF01.
       ...
       SVD-CAS.
           ...
           MOVE "OA" TO CAS-1
           MOVE "23" TO CAS-2
           COMPUTE NUM7 = CAR-REDUCE(X) + CAR-PAID(X)
           PERFORM AMT-LEFT
